...
class SolveActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(boardFound) {
            ...
            et_cell_A1.setText(boardFromOCR.puzzle[0][0].toString())
            et_cell_A2.setText(boardFromOCR.puzzle[0][1].toString())
            et_cell_A3.setText(boardFromOCR.puzzle[0][2].toString())
            et_cell_A4.setText(boardFromOCR.puzzle[0][3].toString())
            et_cell_A5.setText(boardFromOCR.puzzle[0][4].toString())
            et_cell_A6.setText(boardFromOCR.puzzle[0][5].toString())
            et_cell_A7.setText(boardFromOCR.puzzle[0][6].toString())
            et_cell_A8.setText(boardFromOCR.puzzle[0][7].toString())
            et_cell_A9.setText(boardFromOCR.puzzle[0][8].toString())

            et_cell_B1.setText(boardFromOCR.puzzle[1][0].toString())
            et_cell_B2.setText(boardFromOCR.puzzle[1][1].toString())
            et_cell_B3.setText(boardFromOCR.puzzle[1][2].toString())
            et_cell_B4.setText(boardFromOCR.puzzle[1][3].toString())
            et_cell_B5.setText(boardFromOCR.puzzle[1][4].toString())
            et_cell_B6.setText(boardFromOCR.puzzle[1][5].toString())
            et_cell_B7.setText(boardFromOCR.puzzle[1][6].toString())
            et_cell_B8.setText(boardFromOCR.puzzle[1][7].toString())
            et_cell_B9.setText(boardFromOCR.puzzle[1][8].toString())

            et_cell_C1.setText(boardFromOCR.puzzle[2][0].toString())
            et_cell_C2.setText(boardFromOCR.puzzle[2][1].toString())
            et_cell_C3.setText(boardFromOCR.puzzle[2][2].toString())
            et_cell_C4.setText(boardFromOCR.puzzle[2][3].toString())
            et_cell_C5.setText(boardFromOCR.puzzle[2][4].toString())
            et_cell_C6.setText(boardFromOCR.puzzle[2][5].toString())
            et_cell_C7.setText(boardFromOCR.puzzle[2][6].toString())
            et_cell_C8.setText(boardFromOCR.puzzle[2][7].toString())
            et_cell_C9.setText(boardFromOCR.puzzle[2][8].toString())

            et_cell_D1.setText(boardFromOCR.puzzle[3][0].toString())
            et_cell_D2.setText(boardFromOCR.puzzle[3][1].toString())
            et_cell_D3.setText(boardFromOCR.puzzle[3][2].toString())
            et_cell_D4.setText(boardFromOCR.puzzle[3][3].toString())
            et_cell_D5.setText(boardFromOCR.puzzle[3][4].toString())
            et_cell_D6.setText(boardFromOCR.puzzle[3][5].toString())
            et_cell_D7.setText(boardFromOCR.puzzle[3][6].toString())
            et_cell_D8.setText(boardFromOCR.puzzle[3][7].toString())
            et_cell_D9.setText(boardFromOCR.puzzle[3][8].toString())

            et_cell_E1.setText(boardFromOCR.puzzle[4][0].toString())
            et_cell_E2.setText(boardFromOCR.puzzle[4][1].toString())
            et_cell_E3.setText(boardFromOCR.puzzle[4][2].toString())
            et_cell_E4.setText(boardFromOCR.puzzle[4][3].toString())
            et_cell_E5.setText(boardFromOCR.puzzle[4][4].toString())
            et_cell_E6.setText(boardFromOCR.puzzle[4][5].toString())
            et_cell_E7.setText(boardFromOCR.puzzle[4][6].toString())
            et_cell_E8.setText(boardFromOCR.puzzle[4][7].toString())
            et_cell_E9.setText(boardFromOCR.puzzle[4][8].toString())

            et_cell_F1.setText(boardFromOCR.puzzle[5][0].toString())
            et_cell_F2.setText(boardFromOCR.puzzle[5][1].toString())
            et_cell_F3.setText(boardFromOCR.puzzle[5][2].toString())
            et_cell_F4.setText(boardFromOCR.puzzle[5][3].toString())
            et_cell_F5.setText(boardFromOCR.puzzle[5][4].toString())
            et_cell_F6.setText(boardFromOCR.puzzle[5][5].toString())
            et_cell_F7.setText(boardFromOCR.puzzle[5][6].toString())
            et_cell_F8.setText(boardFromOCR.puzzle[5][7].toString())
            et_cell_F9.setText(boardFromOCR.puzzle[5][8].toString())

            et_cell_G1.setText(boardFromOCR.puzzle[6][0].toString())
            et_cell_G2.setText(boardFromOCR.puzzle[6][1].toString())
            et_cell_G3.setText(boardFromOCR.puzzle[6][2].toString())
            et_cell_G4.setText(boardFromOCR.puzzle[6][3].toString())
            et_cell_G5.setText(boardFromOCR.puzzle[6][4].toString())
            et_cell_G6.setText(boardFromOCR.puzzle[6][5].toString())
            et_cell_G7.setText(boardFromOCR.puzzle[6][6].toString())
            et_cell_G8.setText(boardFromOCR.puzzle[6][7].toString())
            et_cell_G9.setText(boardFromOCR.puzzle[6][8].toString())

            et_cell_H1.setText(boardFromOCR.puzzle[7][0].toString())
            et_cell_H2.setText(boardFromOCR.puzzle[7][1].toString())
            et_cell_H3.setText(boardFromOCR.puzzle[7][2].toString())
            et_cell_H4.setText(boardFromOCR.puzzle[7][3].toString())
            et_cell_H5.setText(boardFromOCR.puzzle[7][4].toString())
            et_cell_H6.setText(boardFromOCR.puzzle[7][5].toString())
            et_cell_H7.setText(boardFromOCR.puzzle[7][6].toString())
            et_cell_H8.setText(boardFromOCR.puzzle[7][7].toString())
            et_cell_H9.setText(boardFromOCR.puzzle[7][8].toString())

            et_cell_I1.setText(boardFromOCR.puzzle[8][0].toString())
            et_cell_I2.setText(boardFromOCR.puzzle[8][1].toString())
            et_cell_I3.setText(boardFromOCR.puzzle[8][2].toString())
            et_cell_I4.setText(boardFromOCR.puzzle[8][3].toString())
            et_cell_I5.setText(boardFromOCR.puzzle[8][4].toString())
            et_cell_I6.setText(boardFromOCR.puzzle[8][5].toString())
            et_cell_I7.setText(boardFromOCR.puzzle[8][6].toString())
            et_cell_I8.setText(boardFromOCR.puzzle[8][7].toString())
            et_cell_I9.setText(boardFromOCR.puzzle[8][8].toString())
        }
